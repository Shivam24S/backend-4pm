...
export const updateUserSchema = registerSchema
  .fork(["name", "phone", "address", "password"], (field) => field.optional())
  .fork(["role", "email"], (field) => field.forbidden())
  .or("name", "phone", "address", "password")
  .messages({
    "any.missing":
      "name or phone or address or password is required for update",
  });
